    ...
    <div className={classes.about}>
      ...
      <div className={classes.content}>
        <Text view="p-20" color="secondary">
          Welcome to Lalasia, your premier destination for quality furniture and home decor. 
          We believe that every home deserves beautiful, functional pieces that reflect your unique style.
        </Text>
        ...
        <Text view="p-20" color="secondary">
          We pride ourselves on competitive pricing, fast shipping, and outstanding customer service. 
          Every product in our store is selected with care, ensuring you receive only the best 
